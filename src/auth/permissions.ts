...
export const SIDEBAR_PERMISSION_MAP: Record<string, string[]> = {
  ...
  "home-promos": [PERMISSIONS.HOME_VIEW],
  "promo-codes": [PERMISSIONS.HOME_VIEW],
  "membership-plans": [PERMISSIONS.HOME_VIEW],
  "help-faqs": [PERMISSIONS.CMS_VIEW],
  ...
  "staff-records": [PERMISSIONS.SOS_VIEW, PERMISSIONS.STAFF_VIEW],
  "support-tickets": [PERMISSIONS.SOS_VIEW],
  ambulances: [PERMISSIONS.SOS_VIEW, PERMISSIONS.STAFF_VIEW],
  shifts: [PERMISSIONS.SOS_VIEW, PERMISSIONS.STAFF_VIEW],
  hospitals: [PERMISSIONS.SOS_VIEW, PERMISSIONS.STAFF_VIEW],
