...
import { departmentApi } from "../services/admin-api";
...
const emptyDept = { name: "", description: "", isActive: true, sortOrder: 0 };
  ...
  return (
    <div className="p-6">
      <PageHeader
        ...
        subtitle={`${total || departments.length} department(s)`}
        actions={
      ...
      <Table>
        ...
        <TBody>
          {loading ? (
            ...
            <TableState colSpan={4}>No departments found.</TableState>
          ) : (
            departments.map((d) => (
              <TR key={d._id}>
